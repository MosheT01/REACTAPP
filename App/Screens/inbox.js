...
const Inbox = ({ navigation }) => {
    ...
    const [messages, setMessages] = useState(messagess); // define messages state
            ...
            <Modal visible={newMessageModalVisible}>
                <View style={styles.modalContainer}>
                    ...
                    <TextInput
                        ...
                        onChangeText={(text) => setNewMessage({
                            ...newMessage,
                            receiver: text,
                        })}
                    />
                    ...
                    <View style={styles.modalButtons}>
                        <Button title="Cancel" onPress={() => setNewMessageModalVisible(false)} />
