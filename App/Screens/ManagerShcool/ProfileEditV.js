...
const ProfileScreen = ({ route }) => {
  ...
  const handleShirtSizeChange = () => {
    if (modalVisible === "shirtSize") {
      setShirtSize(newValue);
    } else if (modalVisible === "volunteerPlace") {
      setVolunteerPlace(newValue);
    }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.fieldContainer}>
        ...
        <Button
          title="שנה"
          onPress={() => {
            setModalVisible("volunteerPlace");
            setNewValue(volunteerPlace);
          }}
        />
      </View>
      ...
      <Modal visible={!!modalVisible} animationType="slide">
        <View style={styles.modalContainer}>
          ...
          />
          <View style={styles.buttonContanter}>
